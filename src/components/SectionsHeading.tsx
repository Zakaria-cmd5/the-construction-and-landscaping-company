    ...
    <div className="flex flex-col md:flex-row justify-between items-center">
      ...
      <Link
        ...
        className="mr-4 w-[200px] h-[60px] mt-5 flex items-center justify-center bg-[#074143] rounded-lg text-[#EEF9F3] text-[20px] leading-[25px] font-medium
          sm:w-[150px] sm:h-[65px] sm:text-[22px] sm:leading-[28px] md:w-[200px] md:h-[70px] md:text-[24px] md:leading-[30px] 2xl:w-[260px] lg:h-[73px] lg:text-[28px] lg:leading-[33.89px]"
      >
        VIEW ALL
      </Link>
    </div>
