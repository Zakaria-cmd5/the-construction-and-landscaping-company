...
const SignupForm = () => {
  ...
  return (
    <div>
      ...
      {errors.password && <ErrorMessage>{errors.phoneNumber}</ErrorMessage>}
      {errors.password && <ErrorMessage>{errors.city}</ErrorMessage>}
      {errors.password && <ErrorMessage>{errors.country}</ErrorMessage>}
      {errors.password && <ErrorMessage>{errors.userName}</ErrorMessage>}
    </div>
  );
};
